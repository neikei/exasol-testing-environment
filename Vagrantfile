...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    vb.customize ["modifyvm", :id, "--name", "exasol-testing-environment"]
  end
  ...
  config.hostmanager.aliases = 'exasol.test'
  config.vm.hostname = 'exasol-testing-environment'
  ...
  # Post-up message
  config.vm.post_up_message = "See https://github.com/neikei/exasol-testing-environment for help and bug reports."
